...
import {TextInput, Button, Text, useTheme, Card, Avatar, IconButton} from 'react-native-paper'
    ...
    return(
        ...
        <SafeAreaView style={containerstyle.container}>
            ...
            <ScrollView style={{width:'100%'}}>
                ...
                <TextInput label='Nome' onChangeText={(text)=>setName(text)} value={name} style={[containerstyle.inputs]} autoComplete='off' mode='outlined'/>

                <TextInput label='Email' autoCapitalize='none' inputMode='email' keyboardType='email-address' textContentType='emailAddress' onChangeText={(text)=>setEmail(text.trim())} value={email} style={[containerstyle.inputs]} autoComplete='off' mode='outlined'/>

                <TextInput label='CNPJ' keyboardType={"phone-pad"} onChangeText={(text)=>setCnpj(text)} value={cnpj} style={[containerstyle.inputs]} autoComplete='off' mode='outlined' />
                <TextInput label='Empresa' onChangeText={(text)=>setEmpresa(text)} value={empresa} style={[containerstyle.inputs]} autoComplete='off' mode='outlined' />
